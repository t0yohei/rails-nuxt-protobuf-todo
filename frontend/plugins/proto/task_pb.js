...
proto.Tasks.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getTask()
  if (f != null) {
    writer.writeMessage(1, f, proto.Task.serializeBinaryToWriter)
  }
}
 ...
 * @return {?proto.Task}
 */
proto.Tasks.prototype.getTask = function() {
  return /** @type{?proto.Task} */ (jspb.Message.getWrapperField(
    this,
    proto.Task,
    1
  ))
...
proto.Tasks.prototype.setTask = function(value) {
 ...
 */
proto.Tasks.prototype.clearTask = function() {
 ...
 * @return {boolean}
 */
proto.Tasks.prototype.hasTask = function() {
